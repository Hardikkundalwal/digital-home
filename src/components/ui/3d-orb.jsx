...
export default function Orb() {
  ...
  useEffect(() => {
    ...
    let scene, camera, renderer, controls, animationId, hintTimer;
    ...
    try {
     ...
     `
      ...
      const loadTexture = (url) =>
        new Promise((resolve) => {
          textureLoader.load(url, (texture) => resolve(texture), undefined, () => resolve(null))
        })

      Promise.all([
        loadTexture("https://images.unsplash.com/photo-1446776653964-20c1d3a81b06?w=1024&q=80"),
        loadTexture("https://images.unsplash.com/photo-1446776877081-d282a0f896e2?w=1024&q=80"),
        loadTexture("https://images.unsplash.com/photo-1446776653964-20c1d3a81b06?w=1024&q=80"),
      ...
      console.warn("ThreeJS/Orb initialization failed:", e)
    }

    let resizePending = false
    const handleResize = () => {
      if (!resizePending && renderer && camera) {
        resizePending = true
